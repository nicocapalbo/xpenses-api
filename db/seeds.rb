...
10.times {
  Transaction.create!(ledger: Ledger.first, account: Account.first, date: Date.today, info: 'some info', subcategory: Subcategory.find(rand(1..4)), input: rand(-20..20), cleared: true)
}
